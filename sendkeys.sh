...
declare -A key_map=(
    # Lowercase alphabet letters (no shift needed)
    ...
    # Uppercase alphabet letters (requires shift modifier)
    ...
    ['(']="0xe1 0x26"   [')']="0xe1 0x27"   ['_']="0xe1 0x2d"   ['+']="0xe1 0x2e"
    ['{']="0xe1 0x2f"   ['}']="0xe1 0x30"   ['|']="0xe1 0x64"   [':']="0xe1 0x33"
    ['"']="0xe1 0x34"   ['<']="0xe1 0x36"   ['>']="0xe1 0x37"   ['?']="0xe1 0x38"
    ['~']="0xe1 0x35"
